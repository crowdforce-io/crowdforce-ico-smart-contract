...
/**
 * CrowdForce token smart contract.
 */
contract CrowdForceToken is AbstractToken {
  /**
  ...
  /**
   * Create new CrowdForce token smart contract, with given number of tokens issued
   ...
   */
  function CrowdForceToken (uint256 _tokenCount) public {
    owner = msg.sender;
